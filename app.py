...
class Besetellungen(QWidget):
    ...
    def init_ui(self):
        ...
        # Tonica = purple
        self.tonica_button.setFixedHeight(50)
        self.tonica_button.setFont(QFont("Segoe UI", 11, QFont.Bold))
        self.tonica_button.setStyleSheet("""
            QPushButton {
        ...
        # Colophony = green
        self.col_button.setFixedHeight(50)
        self.col_button.setFont(QFont("Segoe UI", 11, QFont.Bold))
        self.col_button.setStyleSheet("""
            QPushButton {
        ...
        self.col_button.clicked.connect(self.show_instrument_selection)
        self.tonica_button.clicked.connect(self.show_instrument_selection)
    ...
    def count_item(self, item):
        self.label.setText(f"Du hast {item} gewählt! 🎉")
